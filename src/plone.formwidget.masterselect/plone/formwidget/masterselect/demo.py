...
class IMasterSelectDemo(form.Schema):
    """MasterSelect Demo to demonstrate all options available to use and to
    allow the test modlues a content type to work with.
    """
    ...
    slaveField2 = schema.Choice(
        ...
        description=_(u"This field's visiblity is controlled by the value "
    ...
    slaveMasterField = MasterSelectField(
        ...
        description=_(u"This field's vocabulary is controlled by the value "
                      ...
                      "be hidden. Only the imput field will be hidden while"
    ...
    slaveField4 = schema.Choice(
        ...
        description=_(u"This field's visiblity is controlled by the value "
                      ...
                      "form field disappears while the lable and description"
